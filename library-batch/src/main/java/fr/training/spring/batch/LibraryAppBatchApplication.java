package fr.training.spring.batch;
...
@ComponentScan(basePackages = { "fr.training.spring" })
@EnableBatchProcessing(modular = true)
public class LibraryAppBatchApplication {
	...
	public static void main(final String[] args) {
		final ApplicationContext context = SpringApplication.run(LibraryAppBatchApplication.class, args);
