...
class LibraryApplicationTests {
	...
	public static final Library NATIONAL_LIBRARY_MONTREUIL = new Library(0L, Type.NATIONAL, new Address(93, "Rue des Montreuil", 93100, "Montreuil"), new Director("Romain", "NOEL"));
	public static final Library SCHOOL_LIBRARY_PARIS = new Library(0L, Type.SCHOOL, new Address(75, "Rue de Paris", 75008, "Paris"), new Director("Garfield", "LECHAT"));
	public static final Library PUBLIC_LIBRARY_VINCENNES = new Library(0L, Type.PUBLIC, new Address(94, "Rue de Vincennes", 94200, "Vincennes"), new Director("Garfield", "LECHAT"));
	...
	void test_create_1(){
		...
		//--------------- When ---------------
		// I do a request on /libraries
		final ResponseEntity<Long> response = restTemplate.postForEntity("/libraries", NATIONAL_LIBRARY_MONTREUIL, Long.class);
	...
	class Test_update{
		...
		void test_update_2(){
			...
			//--------------- When ---------------
			final ResponseEntity<String> response = restTemplate.exchange("/libraries/" + Long.MAX_VALUE, HttpMethod.PUT, new HttpEntity<>(SCHOOL_LIBRARY_PARIS), String.class);
	...
	class Test_delete{
		...
		void test_delete_2(){
			...
			//--------------- When ---------------
			final ResponseEntity<String> response = restTemplate.exchange("/libraries/" + Long.MAX_VALUE, HttpMethod.DELETE, null, String.class);
	...
	void test_list_with_filter_1(){
		...
		//--------------- When ---------------
		final ResponseEntity<Library[]> response = restTemplate.getForEntity("/libraries/type/" + Type.NATIONAL, Library[].class);
	...
	void test_list_with_filter_2(){
		...
		//--------------- When ---------------
		final ResponseEntity<Library[]> response = restTemplate.getForEntity("/libraries/director/surname/" + "Garfield", Library[].class);
